  ...
  return (
    <>
      ...
      <Container sx={{ bgcolor: "#fff" }}>
        ...
        <Box width="400px" height="150px" bgcolor="lightcoral" m="60px auto 0">
          logo
        </Box>
        <Box py={5} px={15} textAlign="center">
          <Typography
            variant="h4"
          ...
          <Box p={10}>
            ...
            <Typography fontFamily="Nanum Gothic">
        ...
        <Box p={5} textAlign="center">
          ...
          <Box p={10}>
            ...
            <Typography fontFamily="Nanum Gothic">
              <Typography fontFamily="Nanum Gothic" fontWeight={600}>
                Waht is BPM?
              </Typography>
